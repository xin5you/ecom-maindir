...
public class IntfaceTransLog {
	...
	public String toString() {
		return "IntfaceTransLog [interfacePrimaryKey=" + interfacePrimaryKey + ", settleDate=" + settleDate
				+ ", orgInterfacePrimaryKey=" + orgInterfacePrimaryKey + ", dmsRelatedKey=" + dmsRelatedKey
				+ ", orgDmsRelatedKey=" + orgDmsRelatedKey + ", transId=" + transId + ", transSt=" + transSt
				+ ", insCode=" + insCode + ", mchntCode=" + mchntCode + ", shopCode=" + shopCode + ", respCode="
				+ respCode + ", priAcctNo=" + priAcctNo + ", cardNo=" + cardNo + ", userInfUserName=" + userInfUserName
				+ ", productCode=" + productCode + ", transAmt=" + transAmt + ", uploadAmt=" + uploadAmt
				+ ", transCurrCd=" + transCurrCd + ", transChnl=" + transChnl + ", transFee=" + transFee
