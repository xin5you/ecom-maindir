...
public class UserMerchantAcct {
	...
	public String toString() {
		return "UserMerchantAcct [userId=" + userId + ", userName=" + userName + ", cardNo=" + cardNo + ", pinStat="
				+ pinStat + ", nopinTxnAmt=" + nopinTxnAmt + ", accountNo=" + accountNo + ", accBal=" + accBal
				+ ", insId=" + insId + ", insCode=" + insCode + ", insName=" + insName + ", mchntId=" + mchntId
				+ ", mchntCode=" + mchntCode + ", mchntName=" + mchntName + ", productCode=" + productCode
				+ ", productName=" + productName + ", channelCode=" + channelCode + ", externalId=" + externalId + "]";
	}
